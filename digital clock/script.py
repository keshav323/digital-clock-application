# Create the backend server files for the digital clock application
import json

# Create package.json for Node.js project
package_json = {
    "name": "digital-clock-pro-backend",
    "version": "1.0.0",
    "description": "Backend API for Digital Clock Pro - Advanced Time Management Application",
    "main": "server.js",
    "scripts": {
    ...
    "keywords": ["digital-clock", "time-management", "pomodoro", "world-clock", "weather", "real-time"],
    "author": "Digital Clock Pro Team",
    "license": "MIT",
    "dependencies": {
        "express": "^4.18.2",
        "socket.io": "^4.7.2",
